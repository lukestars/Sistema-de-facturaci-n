...
def show_paused_invoices(app):
    ...
    tree.column('#0', width=65, minwidth=50, stretch=False, anchor=tk.W)
    tree.column('ID', width=48, minwidth=40, stretch=False, anchor=tk.W)
    tree.column('Fecha', width=90, minwidth=70, stretch=False, anchor=tk.W)
    tree.column('Hora', width=44, minwidth=36, stretch=False, anchor=tk.CENTER)
    tree.column('Cliente', width=90, minwidth=60, stretch=False, anchor=tk.W)
    tree.column('Productos', width=100, minwidth=60, stretch=True, anchor=tk.W)
    tree.column('TotalBS', width=68, minwidth=56, stretch=False, anchor=tk.E)
    tree.column('TotalUSD', width=58, minwidth=48, stretch=False, anchor=tk.E)
